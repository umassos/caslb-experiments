...
def experiment(xi):
    ...
    for _ in range(epochs):
        ...
        try:
            ...
            errordSequence = (1-xi)*simplexSequence + (xi)*randomNoise
            # print(simplexSequence)
            # print(errordSequence) (simplex_cost_functions, dist_matrix, tau, scale, c_simplex, d, start_state):
            adv, adv_gamma_ots, adv_cost = f.optimalSolution(errordSequence, simplex_distances, tau*scale, scale, c_simplex, dim, start_simplex, alt_cost_functions=simplexSequence)
    ...
    with open("xi_carbon/xi_carbon_results{}.pickle".format(xi*100), "wb") as f:
